...
4. Add a link for users choose the translation. In `git-cheatsheet.html`, insert (alphabetically) a new line that looks like:
```
...
Try not to keep the PR restricted to only changes related to the translation.
